    ...
    window.onload = function () {
        ...
        socket.on('log', function (data) {
            ...
            if (intervalId) {
                ...
                if (!!window.config) {
                    $.each(window.config, function (regex, opts) {
                        if (robj.path.match(new RegExp(regex, 'i')) !== null) {
                            m.color = opts.color;

                            if (opts.y) {
                                _y = opts.y * (canvasH - MARGIN_TOP - MARGIN_BOTTOM) + MARGIN_TOP;
                            }

                            if (opts.anim && opts.anim === 'sine') {
                                _y += Math.sin(+ new Date() / 3000) * 20
                            }
                        }
                    })
                }
                ...
                if (srcslotpos < 0) {
                    ...
                    sslot.ip = robj.ip;
                    sslot.count = 1;
                    sslot.y = _y || Math.floor( Math.random() * (canvasH - MARGIN_TOP - MARGIN_BOTTOM) + MARGIN_TOP ); // TODO: Find a correct slot vertical position
                ...
                if (dstslotpos < 0) {
                    ...
                    dslot.count = 1;
                    dslot.y = _y || Math.floor( Math.random() * (canvasH - MARGIN_TOP - MARGIN_BOTTOM) + MARGIN_TOP ); // TODO: Find a correct slot vertical position
